...
/**
 * Creates a mock backend server for PostgreSQL using Sequelize ORM.
 * @param {String} orm - The Object-Relational Mapping (ORM) used (sequelize).
 * @param {String} dialect - The dialect of the database (postgresql).
...
function postgreSequelMock(
  ...
  const sequelize = new Sequelize(database, username, password, {
    ...
    dialect: dialect,
    dialectOptions: {
      // Specify the port for PostgreSQL
      port: seq_port,
    },
  });
...
module.exports = postgreSequelMock;
